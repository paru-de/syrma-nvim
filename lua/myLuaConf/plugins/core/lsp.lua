    ...
    servers.nixd = {
      nixd = {
        nixpkgs = {
          ...
          expr = [[import (builtins.getFlake "]] .. nixCats.extra(
            "nixdExtras.nixpkgs"
          ) .. [[") { }   ]],
        },
        formatting = {
      ...
      if nixCats.extra("nixdExtras.homeCFGname") then
        ...
        servers.nixd.nixd.options["home-manager"] = {
          expr = [[(builtins.getFlake "]]
            .. flakePath
            .. [[").homeConfigurations."]]
            .. nixCats.extra("nixdExtras.homeCFGname")
            .. [[".options]],
        }
      end
    end
...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
    require("myLuaConf.plugins.core.caps-on_attach").on_attach(
      ...
      if require("nixCatsUtils").isNixCats then
        for server_name, cfg in pairs(servers) do
          require("lspconfig")[server_name].setup({
            capabilities = require("myLuaConf.plugins.core.caps-on_attach").get_capabilities(
              server_name
            ),
